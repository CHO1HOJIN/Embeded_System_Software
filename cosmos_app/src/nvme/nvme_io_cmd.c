...
{
    xil_printf("Name: Choi Hojin\r\n");	
    xil_printf("Student ID: 20201654\n");
    xil_printf("Affiliation: ogang University Computer Science and Engineering\r\n");
    xil_printf("Interests: Embedded Systems and Operating Systems\r\n");
    xil_printf("Hobbies: Football, Reading\r\n");
}
